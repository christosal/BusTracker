...
public class Node {
    ...
    public static HashMap<Integer, Broker> local_brokers  = new HashMap<>(); // <BrokerID,com.example.bustracker_app.Broker>
    ...
    /*public void startClient(int port,Object object) {
        ...
        String message;
        try {
            requestSocket = new Socket(InetAddress.getByName(com.example.bustracker_app.Reader.readBrokerIP()), port);
